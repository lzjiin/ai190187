...
<head>
    ...
    <body>
        ...
        <?php
            $SQL = "SELECT count(*) AS Total FROM registered_subject WHERE mcResult='0' AND sbjCode = '$sbjCode'";
            $SQQ = "SELECT count(*) AS Total FROM registered_subject WHERE mcResult!='0' AND sbjCode = '$sbjCode'";
